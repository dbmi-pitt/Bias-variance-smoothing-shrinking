...
```{r contentsAdvice}
# inclRmd('www/contentsAdvice.Rmd')
```
...
# OVERVIEW of this Module  <!-- un#title -->
...
The code for this module is hosted at ['dbmi-pitt/Bias-variance-smoothing-shrinking/'](https://github.com/dbmi-pitt/Bias-variance-smoothing-shrinking/).
